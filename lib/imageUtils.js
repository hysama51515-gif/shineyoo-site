...
const NORMAL_IMAGE_HOSTS = /(images\.unsplash\.com|plus\.unsplash\.com|images\.pexels\.com|cdn\.shopify\.com|res\.cloudinary\.com)/i;
...
export function isLikelyProductImage(value = '') {
  ...
  if (NORMAL_IMAGE_HOSTS.test(lower)) return true;

  if (!IMAGE_HOST_PATTERN.test(lower)) return true;
